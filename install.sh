...
ansible-playbook /opt/pgstage/roles/pts.yml --tags tasks
ansible-playbook /opt/pgstage/roles/pts.yml --tags installer
# ansible-playbook /opt/pgstage/pts.yml --tags source
ansible-playbook /opt/pgstage/roles/pts.yml --tags folders
...
if [ "$start" != "$stored" ]; then
     ansible-playbook /opt/pgstage/roles/pts.yml --tags meta
fi
...
##endrunning
ansible-playbook /opt/pgstage/roles/pts.yml --tags templates
ansible-playbook /opt/pgstage/roles/pts.yml --tags folders
